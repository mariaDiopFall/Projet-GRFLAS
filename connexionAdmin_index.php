...
<body>
  ...
  <div class="header">
    ...
    <div style="text-align:right">
      ...
      <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        <a type="button" href="etatpiste_admin.php" class="btn btn-primary btn-lg  px-5 RSCP" type="submit">Rapport Sur L'État des Surfaces de Pistes</a>
        <a type="button" onclick="document.getElementById('id01').style.display='block'" class="btn btn-primary  btn-lg px-5 ADD">Ajouter fiche de collecte +</a>
        <a type="button" href="listuser.php"  class="btn btn-primary  btn-lg px-5 GES" name="gestionuser" >Gestion des Utilisateurs </a>
  ...
  <div class="container1">
    ...
    <footer class="footer text-center" style="color:white; background-color:#317eeb" align = "center">
        ...
        <div class="container">
          <form method='post' action="traitement_donnee.php" href="etatpiste.php">
            ...
            <div class="row">
              ...
              <div class="col-75">
                <textarea id="info1" name="info1" placeholder="Write something.." style="height:200px" ></textarea>
                <p id='cfl1alerte'></p>
            ...
            <div class="container">
              <div class="col-15">
                ...
                <div class="row">
                  ...
                  <div class="col-75">
                    <textarea id="info2" name="info2" placeholder="Write something.." style="height:200px" ></textarea>
                    <p id='cfl2alerte'></p>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-75">
                    <textarea id="info3" name="info3" placeholder="Write something.." style="height:200px" ></textarea>
                    <p id='cfl3alerte'></p>
                  </div>
                </div>
                <div class="row">
