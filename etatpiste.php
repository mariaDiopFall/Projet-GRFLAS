...
<?php
 ...
 <img id="logo" src="https://image.jimcdn.com/app/cms/image/transf/none/path/s411039637905c6a0/image/id0abf5d5e8cfbc09/version/1623158161/image.jpg" alt="">
    ...
    <div class="contenu">
    <form action="connexion_index.php" method="post" style="text-align:right;" >
...
<div style = "text-align:center;">
  ...
  <a type="button" href="collecte.php"  class="btn btn-primary waves-effect waves-light" name="verifier" >Visualiser La Fiche De Collecte</a>
</div>
<br><br>
